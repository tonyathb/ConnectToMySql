/*minions﻿use minionsdb; */
-- Dumping database structure for minions
CREATE DATABASE IF NOT EXISTS `minionsdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `minionsdb`;minionsdbminions
...
(4,3),
(5,1),
(3,2);minionstownsvillainstownsminionsvillains